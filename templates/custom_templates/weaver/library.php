<?php
	...
	if (weaver_is_checked_page_opt('ttw_hide_sidebars')) echo("<div id=\"container\" class=\"one-column page-with-posts page-with-posts-title2\">\n");
	else echo("<div id=\"container\" class=\"page-with-posts page-with-posts-title2\">\n");
